...
import main.java.OLDdata.paypal.comparator.PayPalGBInvoiceComparator;
...
public class Matcher_PaymentData_PayPalGBN
{
    ...
    public int binarySearchPayPalBySidGroup(ArrayList<PayPalGBInvoice> ppSource, String desiredSid, String desiredDate)
            throws ParseException
    {
        int result = -1;
        ...
        while (lowIndex <= highIndex)
        {
            ...
            PayPalGBInvoice currentPayPal = ppSource.get(midIndex);
