...
//        //DEBUG
//        for(ExchangeRate x: excReader.getContents()) {
...
//        //Debug
//        for(PayPal p: paypalReader.getContents()) {
//            if(p.getName().equals("Alexa Ditz")) {
//                System.out.println("Ditz: " + p.getDate());
//            }
//
//        }
...
//        //DEBUG DEBUG DEBUG
//        for(PayPalGBInvoice pgi: paypalGrouper.getGroupedArray()) {
//            if(pgi.toString().contains("Alexa Ditz")) {
...
//        }
        ...
        Writer<MatchPDPP, PaymentData> pdppWriter = new Writer<>();
        Writer<MatchPDExc, PaymentData> pdExcWriter = new Writer<>();
        Writer<MatchAfterPay, MatchAfterPay> apWriter = new Writer();
