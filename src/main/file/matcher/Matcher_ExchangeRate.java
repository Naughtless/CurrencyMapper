...
import main.data.exchangerate.ExchangeRateGBSource;
...
public class Matcher_ExchangeRate {
    ...
    private HashMap<String, ExchangeRateGBSource> excSource;
    ...
    public Matcher_ExchangeRate(ArrayList<PaymentData> pdSource, HashMap<String, ExchangeRateGBSource> excSource) {
    ...
    public void process() {
        ...
        while(itr.hasNext()) {
             ...
             */
            if(
                    pt.equals("BankTransfer") ||
                    pt.equals("ChargeBack") ||
                    pt.equals("CreditCard") ||
                    pt.equals("Transfer")
            ){
        ...
        ExchangeRateGBSource monthlyExchangeRate = excSource.get("monthly exch rate");
        while(itr.hasNext()) {
            PaymentData cpd = itr.next();
        ...
        itr = pdSource.iterator(); // New iterator
        ExchangeRateGBSource rbaRate = excSource.get("rba rate");
        while(itr.hasNext()) {
            PaymentData cpd = itr.next();
        ...
        itr = pdSource.iterator(); // New iterator
        ExchangeRateGBSource xeRate = excSource.get("xe rate");
        while(itr.hasNext()) {
            PaymentData cpd = itr.next();
    ...
    public HashMap<String, ExchangeRateGBSource> getExcSource() {
        return excSource;
    }

    public void setExcSource(HashMap<String, ExchangeRateGBSource> excSource) {
        this.excSource = excSource;
    }
